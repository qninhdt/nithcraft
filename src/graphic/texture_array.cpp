...
namespace nith
{
    TextureArray::TextureArray(const u32& width, const u32& height, const u32& layers, const u32& numLevels, const GLenum& internalFormat, const GLenum& format, const GLenum& type):
        m_width(width),
        m_height(height),
        m_layers(layers),
    ...
    void TextureArray::setSubImage(const u32& layer, void* data)
    {
        u32 height = m_height;
        u32 width = m_width;
    ...
    void TextureArray::bind(const u32& unit) const
    {
